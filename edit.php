...
<!-- Mirrored from laravel8.spruko.com/noa/datatable by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2023 13:12:03 GMT -->
                        ...
                        <div class="main-container container-fluid">
							...
							<?php endif; ?>
									...
									<div class="row">
										...
										<input type="date" name="start_date" value="<?= $employee['start_date'] ?>" class="form-control" required>
										</div>
										<div class="col-md-6 mb-3">
										<label>Salary</label>
										<input type="text" name="salary" value="<?= htmlspecialchars($employee['salary']) ?>" class="form-control" required>
										</div>
										<div class="col-md-6 mb-3">
										<label>Email</label>
...
<!-- Mirrored from laravel8.spruko.com/noa/datatable by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2023 13:12:08 GMT -->
</html>
